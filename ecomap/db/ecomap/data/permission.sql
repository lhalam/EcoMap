...
(75, 'GET', 'Any', 53, 'Перегляд своїх коментарів в табі юзера.'),
...
(85, 'DELETE', 'Any', 62, 'Видалення проблеми.'),
(86, 'PUT', 'Any', 62, 'Видалення проблеми юзером(проблема переноситься на аноніма).'),

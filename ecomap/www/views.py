...
def login():
    ...
    if request.method == 'POST' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'password', 6, 100, v.validate_key,
        ...
        if not invalid:
            ...
            response = Response(json.dumps({'error': invalid}),
...
def change_password():
    if request.method == 'POST':
        ...
        invalid = v.main_validator([[data, 'id', 1, 1, v.validate_key,
                                     v.validate_empty],
        ...
        if not invalid:
            ...
            if user and user.verify_password(data['old_pass']):
                ...
                return jsonify(), 200
            return jsonify(), 400
        return Response(json.dumps({'error': invalid}),
                        mimetype='application/json')
...
def register():
    ...
    if request.method == 'POST' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'email', 2, 100, v.validate_key,
                                     v.validate_empty, v.validate_string,
                                     v.validate_length, v.validate_email],
...
def resources():
    ...
    if request.method == 'PUT' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'new_resource_name', 2, 100,
                                     v.validate_key, v.validate_empty,
                                     v.validate_string, v.validate_length],
                                    [data, 'resource_id', 1, 1, v.validate_key,
                                     v.validate_empty]])
    ...
    if request.method == 'DELETE' and request.get_json():
        ...
        invalid = v.main_validator([[del_data, 'resource_id', 1, 1,
                                     v.validate_key, v.validate_empty]])
...
def roles():
    ...
    if request.method == 'PUT' and request.get_json():
        ...
        invalid = v.main_validator([[edit_data, 'new_role_name', 2, 100,
                                     v.validate_key, v.validate_empty,
                                     v.validate_string, v.validate_length],
...
def permissions():
    ...
    if request.method == 'POST' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'resource_id', 1, 1,
                                     v.validate_key, v.validate_empty],
    ...
    if request.method == 'PUT' and request.get_json():
        ...
        invalid = v.main_validator([[edit_data, 'new_action', 3, 7,
                                     v.validate_key, v.validate_empty,
                                     v.validate_string, v.validate_length],
    ...
    if request.method == 'DELETE' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'permission_id', 1, 1,
                                     v.validate_key, v.validate_empty]])
...
def get_role_permission():
    ...
    if request.method == 'POST' and request.get_json():
        ...
        invalid = v.main_validator([[data, 'role_id', 1, 1, v.validate_key,
                                     v.validate_empty],
                                    [data, 'permission_id', 1, 1,
                                     v.validate_key, v.validate_empty]])
    ...
    if request.method == 'PUT' and request.get_json():
        ...
        invalid = v.main_validator([[edit_data, 'role_id', 1, 1,
                                     v.validate_key, v.validate_empty],
                                    [edit_data, 'permission_id', 1, 1,
                                     v.validate_key, v.validate_empty]])
